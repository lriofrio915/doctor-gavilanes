                ...
                <div key={`item-social-proof-${index}`}>
                    <a href={link} target="_blank" rel="noopener">
                        <Image
                            src={src}
                            alt={alt}
                            className="h-auto w-12 opacity-50 contrast-50 grayscale duration-75 hover:opacity-100 hover:contrast-100 hover:grayscale-0 hover:dark:filter hover:dark:invert md:w-16"
                            object-fit="contain"
                            width={64}
                            height={64}
                        />
